...
# user_name = driver.find_element(By.XPATH, "//*[@id='user-name']") # FullXPATH
...
# s=Service('C:/Users/User Roman/PycharmProjects/pythonLessons/myprograms/qa_test_classes/chromedriver.exe')
